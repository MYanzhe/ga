...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"首页" style:UIBarButtonItemStyleDone target:self action:@selector(rightClick)];
...
-(void)rightClick{
    [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://sybm024.kuaizhan.com/57/88/p411502065c82a2"]]];
}
